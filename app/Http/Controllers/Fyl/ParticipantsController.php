...
class ParticipantsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('fyl/participants/index', $data);
    ...
    public function edit($id,$campusId,$trainingId,$parameter,$search,$pag)
    {
        $userId = auth()->id();
    ...
    public function payment($id, $campus, $program, $trainingId, $trainingIdEnroller, $training_id, $parameter, $search, $pag)
    {                                                     
    ...
    public function payment_register(Request $request)
    {
        try {
            ...
            $participant = DB::table('fyl_participants')->where('DNI',$request->input('participant_DNI'))->first();
            ...
            $results = DB::select(
                'CALL fyl_insert_payments(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?, @estado, @mensaje)',$datosPago
            ...
            $data = [
                'campus_id' => $campusId,
                'training_id' => $participant->training_id_enroller,
                'parameter' => $parameter,
                'search' => $search,
                'pag' => $pag
                ];
    ...
    public function payment_edit($id, $campus, $program, $program_name, $trainingId, $trainingIdEnroller, $payment_id, $training_id, $parameter, $search, $pag)
    {
        try {
