<x-app-layout :title="$profile->name" meta-description="Este es el Profiles">

    <h1 class="my-4 font-serif text-3xl text-center text-sky-600">{{ $profile->name }}</h1>
    <div class="flex flex-col max-w-xl px-8 py-4 mx-auto bg-white rounded shadow h-96">
        <p class="flex-1 leading-normal text-slate-600">{{ $profile->state }}</p>
