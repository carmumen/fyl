...
<body style="margin:-20px -5px; font-family: 'Montserrat', sans-serif;">
    ...
    <table style="width:100%; margin-top:-3px">
        <tr>
            <td style="width:50%;">
                <img src="{{ asset('images/impetusec.jpg') }}" width="50px" alt="Mi Imagen">
            </td>
            ...
            <p style="font-size:14px; text-align:justify">
                ...
                IMPETUS SAS legalmente representada por su Gerente General el señor:
                ...
                1.- Mediante dinero efectivo, transferencia a la cuenta corriente No 200614402 del banco del Austro a nombre de la
                Empresa IMPETUS SAS o mediante tarjeta de crédito a la suscripción del presente contrato.
            ...
            <table style="width:100%; border-spacing: 10px; border-collapse: separate;">
                ...
                <tr>
                    <td
                        ...
                        EL PRESTADOR<br>
                        <span style="font-size:12px">IMPETUS SAS</span>
                    </td>
                    <td></td>
                    <td
                        style="width: 40%; text-align:center; vertical-align:top; border-top: 0.5px solid black; font-size:14px">
