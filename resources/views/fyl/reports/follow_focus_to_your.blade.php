                    ...
                    <span class="">
                        @if (isset($training) && count($training) > 0)
                            <form id="life" method="GET" class="flex items-center space-x-2"
                                action="{{ route('ReportsFocusToYourCalls.callsFTY') }}">
                                @csrf
            ...
            @if (isset($follow))
                ...
                <div class="p-1">
                    ...
                    focus:outline-none focus:border-green-500"
                        href="{{ url('/exportar-tabla' . '/seguimiento_focus_to_your' . '/' . $trainingId . '/' . $filter) }}">
                ...
                <main class="border border-gray-200 md:rounded-lg">
                    ...
                    <div class="overflow-x-auto">
                        <div id="conResultados">
                            ...
                            @include('fyl/reports.follow_focus_to_your_table', $follow)
