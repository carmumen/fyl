<x-app-layout>
    ...
    <header>
        <div class="flex flex-wrap justify-between mx-8">
                    ...
                    <span class="">
                        @if (isset($training) && count($training) > 0)
                            <form id="life" method="GET" class="flex items-center space-x-2"
                                action="{{ route('ReportsListLife.Listado') }}" enctype="multipart/form-data">
                                @csrf
            ...
            @if (isset($lista_life) && count($lista_life) > 0)
                <div class="p-1">
                    <a class="{{ Config::get('style.btnSave') }}"
                        href="{{ url('/exportar-tabla' . '/listal' . '/' . $trainingId . '/l') }}">
                        Listado</a>
                </div>
            @endif
                ...
                <main class="border border-gray-200 md:rounded-lg">
                    <div class="overflow-x-auto">
                        <div id="conResultados">
                            ...
                            @include('fyl/reports.lista_life_table', $lista_life)
