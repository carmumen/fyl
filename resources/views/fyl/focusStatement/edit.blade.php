<x-app-layout title="Focus Participant" meta-description="Focus Participant">
    ...
    <div class="px-8 py-4 bg-white" style="height:auto">
        ...
        <form method="POST" action="{{ route('FocusParticipants.update', $focusParticipants) }}">
            @csrf @method('PATCH')
            ...
            <div class="space-y-4">
                ...
                <div class="w-full text-center">
                    <b><span class="text-2xl">FOCUS</span></b>
                    </br>
                    <span>{{ $focusParticipants->nickname }} {{ $focusParticipants->surnames }}</span>
                    </br>
                    <span>{{ $focusParticipants->phone }}</span>
                </div>
            ...
            <div class="flex items-center justify-between mt-4">
                <a class="{{ Config::get('style.btnReturn') }}"
                    href="{{ route('FocusParticipants.index', ['training_id' => $focusParticipants->training_id]) }}">@lang('To return')</a>
