<x-app-layout title="Price" meta-description="Price">
    ...
    <h1 class="px-8 py-4 text-2xl text-left text-sky-800 font-semibold">@lang('Create Price')</h1>
    ...
    <form class="px-8 py-4 mx-auto  bg-white rounded shadow w-3/5" style="height:700px" method="POST"
        ...
        @csrf
        @include('fyl/prices.form-fields', ['prices' => new App\Models\Fyl\Prices()])
        <div class="flex items-center justify-between mt-4">
            <a class="{{ Config::get('style.btnReturn') }}" href="{{ route('Prices.index') }}">@lang('To return')</a>
