<div class="space-y-0  p-3 border-b-2   text-lg font-mono bg-white">
    {{-- <div class="flex "> --}}
    {{-- <fieldset class="mx-1 px-2 py-2 border border-solid border-gray-300 p-3">
        <legend class="text-sm"><b>@lang('Personal Data')</b></legend> --}}
            ...
            <div class="flex-1 md:w-1/3 px-4">
                <label class="flex flex-col">
                    ...
                    <input class="{{ Config::get('style.cajaTexto') }}" type="text" name="DNI" minlength="8"
                        ...
                        value=" {{ old('DNI', $participants->DNI) }}"
            ...
            <div class="flex-1 md:w-1/3 px-4">
                <label class="flex flex-col">
                    ...
                    <input class="{{ Config::get('style.cajaTexto') }}" type="text" name="email"
                        value=" {{ old('email', $participants->email) }}" required oninput="this.value = this.value.toLowerCase();"/>
                    @error('email')
                        <small class="font-bold text-red-500/80">{{ $message }}</small>
                    @enderror
                </label>
        ...
        <div class="flex flex-row flex-wrap py-1">
            <div class="flex-1 md:w-1/3 px-4">
                <label class="flex flex-col ">
                    ...
                    <input class="{{ Config::get('style.cajaTexto') }}" type="text" name="city_of_residence"
                        value=" {{ old('city_of_residence', $participants->city_of_residenceT) }}" 
                        required />
        ...
        <div class="flex flex-row flex-wrap py-1">
            <div class="flex-1 md:w-1/2 px-4">
                <span class="{{ Config::get('style.label') }}">@lang('Enfermedad psiquiátrica o en tratamiento?')</span>
            ...
            <div class="flex-1 md:w-1/2 px-4">
                <span class="{{ Config::get('style.label') }}">@lang('¿Tienes algún antecedente médico del cuál debamos tener conocimiento?')</span>
                <div class="flex flex-row">
        ...
        <div class="flex flex-row flex-wrap py-1">
            <div class="flex-1 md:w-1/2 px-4">
                <span class="{{ Config::get('style.label') }}">@lang('¿Tomas algún medicamento que altere tu conducta habitual?')</span>
                <div class="flex flex-row">
