...
<body>
    <form action="{{ route('ProcessCH.formChange') }}" method="POST">
        @csrf
        <input type="hidden" id="training_id_enroller" name="training_id_enroller" value=" {{ $participant->training_id_enroller }}"
            required>
        <input type="hidden" id="training_id" name="training_id" value=" {{ $participant->training_id }}"
            required>
        <input type="hidden" id="DNI_enroller" name="DNI_enroller" value=" {{ $participant->DNI_enroller }}" required>
        <input type="hidden" id="id" name="id" value=" {{ $participant->id }}" required>
