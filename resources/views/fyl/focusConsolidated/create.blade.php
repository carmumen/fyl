<x-app-layout title="Focus Participant" meta-description="Focus Participant">
    ...
    <form class="px-8 py-4 mx-auto  bg-white rounded shadow w-3/5" style="height:700px" method="POST"
        ...
        @csrf
        @include('fyl/focusStatements.form-fields', ['focusStatements' => new App\Models\Fyl\FocusStatements()])
        <div class="flex items-center justify-between mt-4">
            <a class="{{ Config::get('style.btnReturn') }}" href="{{ route('FocusStatements.index') }}">@lang('To return')</a>
