                ...
                <div class="box border border-gray-400" >
                    <table class="w-full table">
                        ...
                        <tr>
                            ...
                            <td style="text-align:center; font-size:14px">
                                {{ $jornadaPagos[0]->deserto_sabado }}
                            </td>
                            <td style="text-align:center; font-size:14px">
                                {{ $jornadaPagos[0]->deserto_domingo }}
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center; font-size:14px">
                                {{ $jornadaPagos[0]->your_viernes + $jornadaPagos[0]->your_life_viernes - $jornadaPagos[0]->deserto_viernes }}
                            </td>
                            <td style="text-align:center; font-size:14px">
                                {{ $jornadaPagos[0]->your_sabado + $jornadaPagos[0]->your_life_sabado - $jornadaPagos[0]->deserto_sabado }}
                            </td>
                            <td style="text-align:center; font-size:14px">
                                {{ $jornadaPagos[0]->your_domingo + $jornadaPagos[0]->your_life_domingo - $jornadaPagos[0]->deserto_domingo }}
                            </td>
                        </tr>
                        <tr>
